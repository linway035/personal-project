...
module.exports = {
  async up(queryInterface, Sequelize) {
    const followships = [
      ...
      { follower_id: 18, following_id: 1 },
      { follower_id: 18, following_id: 2 },
      { follower_id: 18, following_id: 3 },
      { follower_id: 18, following_id: 4 },
      { follower_id: 18, following_id: 5 },
      { follower_id: 18, following_id: 6 },
      { follower_id: 19, following_id: 8 },
      { follower_id: 19, following_id: 9 },
      { follower_id: 19, following_id: 10 },
      { follower_id: 20, following_id: 11 },
      { follower_id: 20, following_id: 12 },
      { follower_id: 20, following_id: 13 },
